...
The functors introduced in the previous section satisfy mutual relation. We recall a few general facts:\checkthis{I removed the theorems, but I would leave the two main categorical facts, since they explain without effort the exactness properties.}
